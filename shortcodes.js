var shortcodes = {
	...
	'method-download': '<polyline points="8 17 12 21 16 17"></polyline><line x1="12" y1="12" x2="12" y2="21"></line><path d="M20.88 18.09A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.29"></path>',
	...
	'method-redirect': '<path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line>',
	...
	'method-iframe': '<path d="M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"></path>',
...
Object.keys(shortcodes).forEach(function(key){
	...
	if( html.includes(shortcode) ){
		if( shortcode == '[whirlocal-logo]' ){
			svg = '<svg class="whirlocal-pin" viewBox="0 0 346 473">'+ shortcodes[key] + '</svg>';
		} else {
			svg = '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">' + shortcodes[key] + '</svg>';
		}

		html = html.replace(expression, svg);
	}
});
